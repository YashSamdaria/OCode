          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group/code">
                ...
                <pre
                  className="relative bg-black/30 rounded-lg p-4 pb-6 overflow-hidden text-sm text-gray-300 font-mono 
               whitespace-pre-wrap break-words line-clamp-3 overflow-ellipsis"
                >
                  {snippet.code}
                </pre>
              </div>
